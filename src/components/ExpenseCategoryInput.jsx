...
export default function ExpenseCategoryInput({label,onChange,name,id,defaultValue,inputError,value,options}) {
        ...
        >
          ...
          </option>
          {
            options.map((option,i) => {
                ...
                <p className="text-xs text-red-500 mt-1.5 absolute top-full">{inputError}</p>
      </div>
  )
}
