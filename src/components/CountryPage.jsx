...
export default function CountryPage() {
  ...
  function useMainData(findData) {
    setCountryDetails({
      ...
      countrySubRegion: findData.subregion
        ? findData.subregion
        : "Not Available",
      countryTLD: findData.tld.join(", "),
      countryCurrency: Object.values(findData.currencies).map(
  ...
  if (countryNotFound === true) {
    ...
    //  return <p className="text-center mt-10">The country currently you're looking for is not available please back to <a className="text-amber-500" href="/">home page</a>.</p>
  }
        ...
        <div className="flex mt-10 flex-wrap gap-8">
          ...
          <div className="contentArea self-center">
            ...
            <div className="subContentArea flex md:max-h-52 gap-x-16 gap-y-4 flex-col flex-wrap">
              ...
              <p className="font-semibold">
                Currencies :{" "}
                <span>{countryDetails.countryCurrency.join(", ")}</span>
              </p>
              <p className="font-semibold">
                Languages :{" "}
                <span className="w-full">
                  {countryDetails.countryLanguages}
                </span>
              </p>
            </div>
