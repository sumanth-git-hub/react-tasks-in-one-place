...
const features = [
  {
    ...
    description:
      "We use JavaScript to build interactive, high-performance frontends that keep users engaged and deliver seamless digital experiences.",
    codeSnippet: `function highlightActiveSection() {
  let currentSection = "";
  ...
  {
    title: "React.js for SPA",
    description:
      "React.js enables fast, scalable, and component-based web applications with efficient rendering and smooth user experiences.",
    codeSnippet: `import React from "react";

export default function App() {
  const title = "Welcome to My Agency";
  ...
  {
    title: "React Native for App",
    description:
      "React Native allows us to build high-performance mobile apps for iOS and Android using a single, efficient codebase.",
    codeSnippet: `import React from "react";
import { View, Text } from "react-native";

export default function App() {
  return <View><Text>Welcome to My App</Text></View>;
}`,
    imagePosition: "left",
  },
];
